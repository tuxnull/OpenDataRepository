...
if(!mysqli_num_rows($qr)>0){
	mysqli_query($mylink,'CREATE TABLE data(id int NOT NULL AUTO_INCREMENT,name tinytext,link text,description text,file mediumtext, tagged int, PRIMARY KEY (id));');
